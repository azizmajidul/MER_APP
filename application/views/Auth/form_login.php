...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url() ?>vendor/adminLTE/index2.html">
                <h1 class="h4 text-gray-900 mb-4"><b>MIS</b>Administration
            </a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <p class="login-box-msg">Merchandiser Information System</p>

                <form action="<?= base_url() ?>vendor/adminLTE/index3.html" method="post">
                    ...
                    <div class="col-8"></div>
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-primary btn-block"><span class="fas fa-plane"></span> Sign In</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
